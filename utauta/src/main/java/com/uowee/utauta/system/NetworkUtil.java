...
public final class NetworkUtil {
    ...
    public static ConnectivityManager getConnectivityManager() {
        return (ConnectivityManager) Util.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    }
    ...
    public static boolean printNetworkInfo() {
        ConnectivityManager connectivity = (ConnectivityManager) Util.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
